    ...
    public function run(): void
    {
        DB::table('images')->insert(
            [
                ...
                ['explanation' => "メンズニット","filepath" => "/images/M'Tshirt/BL0358-BM0_FLAT.jpg","product_id" => 7], 
                ...
                ['explanation' => "ウィメンズニット","filepath" => "/images/W'Tshirt/CL0199-CVD_FLAT.jpg","product_id" => 20], 
                ['explanation' => "ウィメンズTシャツ","filepath" => "/images/W'Tshirt/AL0351-AB8_E.jpg","product_id" => 21], 
                ['explanation' => "ウィメンズTシャツ","filepath" => "/images/W'knit/A60280-BP5_FLAT.jpg","product_id" => 22], 
